...
open class SncfRepositoryException(message: String? = null, cause: Throwable? = null) : Exception(message, cause) {
    constructor(cause: Throwable) : this(null, cause)

    class NetworkException(cause: Throwable) : SncfRepositoryException("Network error occurred: ${cause.message}", cause)
